...
const CAPABILITIES = [
  ...
  },
  {
    ...
    optional: ['--provider <auto|static|unity-mcp>', '--bootstrap', '--dispositions <file>', '--cache-dir <dir>', '--no-cache', '--refresh-cache', '--manifest <file>', '--target-scene <file.scene>', '--force', '--dry-run', '--json'],
  ...
  },
  {
    ...
    args: ['--unity-project <UnityProjectRoot>', '--cocos-project <CocosProjectRoot>'],
    optional: ['--provider <static|auto|unity-mcp>', '--bootstrap', '--dispositions <file>', '--cache-dir <dir>', '--no-cache', '--refresh-cache', '--manifest <file>', '--wiring <file>', '--packet <file>', '--target-scene <file.scene>', '--force', '--dry-run', '--json'],
