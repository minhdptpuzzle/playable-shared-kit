...
const CAPABILITIES = [
  ...
  },
  {
    ...
    args: ['--unity-project <UnityProjectRoot>', '--cocos-project <CocosProjectRoot>'],
    optional: ['--manifest <file>', '--preview-url <url>', '--no-run-gates', '--json'],
