Shader "Hovl/Particles/Distortion"
{
    ...
    // HOVL_URP_PASS - keep the original Built-in subshader below for compatibility.
    SubShader
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
            #pragma target 3.0
            #pragma vertex HovlVert
            #pragma fragment HovlFrag
            #define HOVL_DISTORTION 1
            #include "Assets/Hovl Studio/Resources/Shaders/HovlURPCommon.hlsl"
            ENDHLSL
        }
    }
